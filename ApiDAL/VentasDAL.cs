...
namespace ApiDAL
{
    public class VentasDAL
    {
        ...
        private readonly ILogger<VentasDAL> _Logger;

        public VentasDAL(IConfiguration configuration, ILogger<VentasDAL> logger)
        {
                    ...
                    foreach (var q in lstSqlScripts)
                    {
                        ...
                        try
                        {
                            ...
                            scripts.Add(new SPOS_SQLScripts()
                            {
                                ...
                                UserName = lst.UserName,
                                UrlSQS = lst.UrlSQS,
                                fechaInicial = param.Param1,
                                fechaFinal = param.Param2,
                                ConTransmisionInicial = lst.ConTransmisionInicial
                                //TicketsFaltantes = lst.TicketsFaltantes
                            });
                        }
        ...
        public static DateTime GetJsonDateTime(JsonElement element, string propertyName)
        {
            ...
            // Si no existe o no se puede parsear, devuelve la fecha/hora actual
            return DateTime.Now;
        }
        /// <summary>
        ...
        /// <summary>
        /// Obtiene el servidor con base a la Clave Simi
        /// </summary>
        /// <param name="sucursal"></param>
        /// <param name="dbConnection"></param>
        /// <returns></returns>
        //private async Task<List<OrquestadorServidorMySQL>> GetObtieneServidores(string sucursal, string dbConnection)
        //{
        //    var query = @"SELECT    B.IdEmpresa, 
        //                            B.HostName, 
        //                            B.UserName, 
        //                            B.Password, 
        //                            B.DatabaseName,
        ...
        //			                UserNameReference,
        //			                PasswordReference,
        //			                IFNULL(ReplicarEnLinea,0) ReplicarEnLinea,
        //			                SC.IdSucursal 
        ...
        //                  INNER JOIN sucursal SC ON B.IdEmpresa = SC.IdEmpresa
        //                  WHERE B.Activo = 1 AND SC.ClaveSimi = @Sucursal";

        //    using var connection = new MySqlConnection(dbConnection);
        //    await connection.OpenAsync();

        //    var servidores = await connection.QueryAsync<OrquestadorServidorMySQL>(query, new { Sucursal = sucursal });
        //    Logger.Info($"Total de servidores encontrados: {servidores.Count()}");
        //    await connection.CloseAsync();
        //    return servidores.ToList();
        //}
